...
// searializing the user to the key in the cookies
...
passport.setAuthenticatedUser = function (req, res, next){
    if (req.isAuthenticated()){
        //req.user containes the signed in user from the session cookie and we are justswnding this to the local to the views
